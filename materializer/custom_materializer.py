...
class cs_materializer(BaseMaterializer):
    ...
    def handle_input(
        ...
        """
        It loads the src from the artifact and returns it.

        Args:
            data_type: The type of the src to be loaded
        """
    ...
    def handle_return(
        ...
        """
        It saves the src to the artifact store.

        Args:
            src: The src to be saved
        """
